...
tc_struct test_case[] =
{
    ...
    {/*11*/ 0, MFX_IOPATTERN_IN_SYSTEM_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY, 0, MFX_ERR_NONE },
    // IN = VIDEO
    {/*12*/ 0, MFX_IOPATTERN_IN_VIDEO_MEMORY|MFX_IOPATTERN_OUT_SYSTEM_MEMORY,  0, MFX_ERR_NONE },
    {/*13*/ 0, MFX_IOPATTERN_IN_VIDEO_MEMORY|MFX_IOPATTERN_OUT_VIDEO_MEMORY,   0, MFX_ERR_NONE },
    {/*14*/ 0, MFX_IOPATTERN_IN_VIDEO_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY,  0, MFX_ERR_NONE },
    // IN = OPAQ
    {/*15*/ 0, MFX_IOPATTERN_IN_OPAQUE_MEMORY|MFX_IOPATTERN_OUT_SYSTEM_MEMORY, 0, MFX_ERR_NONE },
    {/*16*/ 0, MFX_IOPATTERN_IN_OPAQUE_MEMORY|MFX_IOPATTERN_OUT_VIDEO_MEMORY,  0, MFX_ERR_NONE },
    {/*17*/ 0, MFX_IOPATTERN_IN_OPAQUE_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY, 0, MFX_ERR_NONE },
        //AsyncDepth = 3
    // IN = SYSTEM
    ...
    {/*20*/ 0, MFX_IOPATTERN_IN_SYSTEM_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY, 3, MFX_ERR_NONE },
    // IN = VIDEO
    {/*21*/ 0, MFX_IOPATTERN_IN_VIDEO_MEMORY|MFX_IOPATTERN_OUT_SYSTEM_MEMORY,  3, MFX_ERR_NONE },
    {/*22*/ 0, MFX_IOPATTERN_IN_VIDEO_MEMORY|MFX_IOPATTERN_OUT_VIDEO_MEMORY,   3, MFX_ERR_NONE },
    {/*23*/ 0, MFX_IOPATTERN_IN_VIDEO_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY,  3, MFX_ERR_NONE },
    // IN = OPAQ
    {/*24*/ 0, MFX_IOPATTERN_IN_OPAQUE_MEMORY|MFX_IOPATTERN_OUT_SYSTEM_MEMORY, 3, MFX_ERR_NONE },
    {/*25*/ 0, MFX_IOPATTERN_IN_OPAQUE_MEMORY|MFX_IOPATTERN_OUT_VIDEO_MEMORY,  3, MFX_ERR_NONE },
    {/*26*/ 0, MFX_IOPATTERN_IN_OPAQUE_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY, 3, MFX_ERR_NONE },
        //AsyncDepth = 5
    // IN = SYSTEM
    ...
    {/*29*/ 0, MFX_IOPATTERN_IN_SYSTEM_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY, 5, MFX_ERR_NONE },
    // IN = VIDEO
    {/*30*/ 0, MFX_IOPATTERN_IN_VIDEO_MEMORY|MFX_IOPATTERN_OUT_SYSTEM_MEMORY,  5, MFX_ERR_NONE },
    {/*31*/ 0, MFX_IOPATTERN_IN_VIDEO_MEMORY|MFX_IOPATTERN_OUT_VIDEO_MEMORY,   5, MFX_ERR_NONE },
    {/*32*/ 0, MFX_IOPATTERN_IN_VIDEO_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY,  5, MFX_ERR_NONE },
    // IN = OPAQ
    {/*33*/ 0, MFX_IOPATTERN_IN_OPAQUE_MEMORY|MFX_IOPATTERN_OUT_SYSTEM_MEMORY, 5, MFX_ERR_NONE },
    {/*34*/ 0, MFX_IOPATTERN_IN_OPAQUE_MEMORY|MFX_IOPATTERN_OUT_VIDEO_MEMORY,  5, MFX_ERR_NONE },
    {/*35*/ 0, MFX_IOPATTERN_IN_OPAQUE_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY, 5, MFX_ERR_NONE },
    ...
    {/*38*/ wrong_resol, MFX_IOPATTERN_IN_SYSTEM_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY, 5, MFX_ERR_NONE },
