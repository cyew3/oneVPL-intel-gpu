...
const TestSuite::tc_struct TestSuite::test_case[] = 
{
    ...
    // FourCC cases (only MFX_FOURCC_R16 at IN and (MFX_FOURCC_RGB4 || MFX_FOURCC_ARGB16) at OUT are supported, 0 is invalid value)
    ...
    {/* 4*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 3, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.FourCC,  0}, 
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.FourCC, 0}}},
    {/* 5*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.FourCC,  MFX_FOURCC_NV12}, 
    ...
    {/* 7*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.FourCC,  MFX_FOURCC_NV12}, 
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.FourCC, MFX_FOURCC_RGB4}}},
    {/* 8*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.FourCC,  MFX_FOURCC_YV12}, 
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.FourCC, MFX_FOURCC_YV12}}},
    {/* 9*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.FourCC,  MFX_FOURCC_P8}, 
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.FourCC, MFX_FOURCC_P8}}},
    {/*10*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.FourCC,  MFX_FOURCC_RGB4}, 
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.FourCC, MFX_FOURCC_RGB4}}},
    {/*11*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.FourCC,  MFX_FOURCC_YUY2}, 
    ...
    {/*15*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.ChromaFormat, MFX_CHROMAFORMAT_MONOCHROME},
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.ChromaFormat, MFX_CHROMAFORMAT_MONOCHROME}}},
    {/*16*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.ChromaFormat, MFX_CHROMAFORMAT_YUV422    },
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.ChromaFormat, MFX_CHROMAFORMAT_YUV422}}},
    {/*17*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.ChromaFormat, MFX_CHROMAFORMAT_YUV444    },
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.ChromaFormat, MFX_CHROMAFORMAT_YUV444}}},
    {/*18*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.ChromaFormat, MFX_CHROMAFORMAT_YUV400    },
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.ChromaFormat, MFX_CHROMAFORMAT_YUV400}}},
    {/*19*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.ChromaFormat, MFX_CHROMAFORMAT_YUV411    },
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.ChromaFormat, MFX_CHROMAFORMAT_YUV411}}},
    {/*20*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.ChromaFormat, MFX_CHROMAFORMAT_YUV422H   },
    ...
    {/*23*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.Width,   0},
                                                                                 {&tsStruct::mfxVideoParam.vpp.In.Height,  0}, 
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.Width,  0},
                                                                                 {&tsStruct::mfxVideoParam.vpp.Out.Height, 0}} },
    {/*24*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.Width,   721},
    ...
    {/*25*/ MFX_ERR_INVALID_VIDEO_PARAM,  0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.Width,   680},
    ...
    {/*27*/ MFX_ERR_NONE,                 0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.AspectRatioW,  666},  //ARs should be ignored during Init
    ...
    {/*28*/ MFX_ERR_NONE,                 0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.FrameRateExtN,  30},  //Frame rate should be
    ...
    {/*29*/ MFX_ERR_NONE,                 0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.FrameRateExtN,  60},
    ...
    {/*30*/ MFX_ERR_NONE,                 0, 1, SET_ALLOCATOR|ALLOC_MIN,        {{&tsStruct::mfxVideoParam.vpp.In.FrameRateExtN,  240},
    ...
    {/*54*/  MFX_ERR_INVALID_VIDEO_PARAM, 0, 1, SET_ALLOCATOR|ALLOC_MIN, {}, {ext_buf, EXT_BUF_PAR(mfxExtVPPComposite           )}},
