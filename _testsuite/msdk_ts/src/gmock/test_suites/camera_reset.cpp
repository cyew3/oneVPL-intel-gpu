...
const TestSuite::tc_struct TestSuite::test_case[] = 
{
    ...
    {/* 4*/ MFX_ERR_NONE, 0,
       {{INIT|MFXVPAR, &tsStruct::mfxVideoParam.IOPattern, {MFX_IOPATTERN_OUT_VIDEO_MEMORY|MFX_IOPATTERN_OUT_VIDEO_MEMORY}},
        {REPEAT, 0, {2}}}
    },
    ...
    {/*29*/ MFX_ERR_INVALID_VIDEO_PARAM, 0, {RESET|MFXVPAR, &tsStruct::mfxVideoParam.vpp.In.FourCC, {MFX_FOURCC_YV12}}},
