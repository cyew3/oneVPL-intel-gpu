...
//    {/*55*/  MFX_ERR_UNDEFINED_BEHAVIOR,  DIFFERENT_IO, {}, {{ext_buf, EXT_BUF_PAR(mfxExtCamBayerDenoise         )},{ext_buf, EXT_BUF_PAR(mfxExtCamColorCorrection3x3   )} }},
    ...
    {/*71*/  MFX_ERR_UNSUPPORTED,   INPLACE,       {&tsStruct::mfxVideoParam.IOPattern,  MFX_IOPATTERN_IN_SYSTEM_MEMORY|MFX_IOPATTERN_OUT_OPAQUE_MEMORY} },
   ...
   {/*111*/  MFX_ERR_UNSUPPORTED,  INPLACE,           { {&tsStruct::mfxVideoParam.vpp.In.CropW,   645},
