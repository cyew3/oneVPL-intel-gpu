...
const TestSuite::tc_struct TestSuite::test_case[] =
{
    ...
    // wrong resolution heigth
    {/*42*/ MFX_WRN_INCOMPATIBLE_VIDEO_PARAM, MFX_LEVEL_HEVC_41, RESOLUTION, BIG_H, {
        { MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN },
        { MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_4 },
    ...
    // wrong resolution
    {/*57*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_5, RESOLUTION, NOT_ALLIGNED, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_5},
    ...
    // wrong slices
    {/*60*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_5, SLICE, NONE, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_5},
    ...
    // wrong kbps
    {/*61*/ MFX_WRN_INCOMPATIBLE_VIDEO_PARAM, MFX_LEVEL_HEVC_51, BR, NONE, {
        { MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN },
        { MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_5 },
    ...
    // wrong resolution
    {/*63*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_51, RESOLUTION, NOT_ALLIGNED, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_51},
    ...
    // wrong slices
    {/*66*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_51, SLICE, NONE, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_51},
    ...
    // wrong kbps
    {/*67*/ MFX_WRN_INCOMPATIBLE_VIDEO_PARAM, MFX_LEVEL_HEVC_52, BR, NONE, {
        { MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN },
        { MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_51 },
    ...
    // wrong resolution
    {/*69*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_52, RESOLUTION, NOT_ALLIGNED, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_52},
    ...
    // wrong slices
    {/*72*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_52, SLICE, NONE, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_52},
    ...
    // wrong resolution
    {/*74*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_6, RESOLUTION, NOT_ALLIGNED, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_6},
    ...
    // wrong slices
    {/*77*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_6, SLICE, NONE, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_6},
    ...
    // wrong resolution
    {/*79*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_61, RESOLUTION, NOT_ALLIGNED, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_61},
    ...
    // wrong slices
    {/*82*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_61, SLICE, NONE, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_61},
    ...
    // wrong resolution
    {/*84*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_62, RESOLUTION, NOT_ALLIGNED, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_62},
    ...
    // wrong slices
    {/*87*/ MFX_ERR_INVALID_VIDEO_PARAM, MFX_LEVEL_HEVC_62, SLICE, NONE, {
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecProfile, MFX_PROFILE_HEVC_MAIN},
        {MFXPAR, &tsStruct::mfxVideoParam.mfx.CodecLevel, MFX_LEVEL_HEVC_62},
    ...
    {/*88*/ MFX_WRN_INCOMPATIBLE_VIDEO_PARAM, MFX_LEVEL_HEVC_1, PROFILE, NONE, {
    ...
    {/*89*/ MFX_ERR_UNSUPPORTED, MFX_LEVEL_HEVC_1, PROFILE, NONE, {
...
int TestSuite::RunTest(unsigned int id)
{
    ...
    *m_uid = MFX_PLUGINID_HEVCE_HW;
    ...
    {
        Init();
        if (tc.exp_level != m_par.mfx.CodecLevel)
        {
            g_tsLog << "Return invalid CodecLevel: " << m_par.mfx.CodecLevel << ", expected: " << tc.exp_level << "!\n";
