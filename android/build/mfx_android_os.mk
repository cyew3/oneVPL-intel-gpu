...
#   MFX_INCLUDES_OMX - include paths to OMX headers (all needed for plug-ins)
#   MFX_INCLUDES_C2 - include paths to C2 headers (all needed for plug-ins)
...
ifeq ($(BOARD_USES_GRALLOC1),true)
  MFX_INCLUDES_OMX += $(INTEL_MINIGBM)/cros_gralloc
  MFX_INCLUDES_C2 := $(INTEL_MINIGBM)/cros_gralloc
endif
