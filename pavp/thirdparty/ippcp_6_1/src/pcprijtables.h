...
// This softtare is supplied under the terms of a license agreement or
// nondisclosure agreement tith Intel Corporation and may not be copied
// or disclosed except in accordance tith the terms of that agreement.
...
*/
#if !defined(_IPP_TRS)
extern const Ipp8u RijEncSbox[256];    /* pure encryption S-box */
extern const Ipp8u RijDecSbox[256];    /* pure decryption S-box */
#endif

#if !defined(_IPP_TRS)
extern const Ipp32u RijEncTbl[4][256]; /* precomputed encryption tables */
extern const Ipp32u RijDecTbl[4][256]; /* precomputed decryption tables */
#endif
