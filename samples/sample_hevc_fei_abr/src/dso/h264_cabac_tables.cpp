...
using namespace BS_H264;

const Bs8s CtxInitTable_0_10_x1[11][2] = {
// 0 - 10
    { 20, -15},
    {  2,  54},
    {  3,  74},
...
const Bs8s CtxInitTable_11_59_x3[49][3][2] = {
//const Bs8s CtxInitTable_11_23_x3[13][3][2] = {
    {{ 23,  33}, { 22,  25}, { 29,  16}},
    {{ 23,   2}, { 34,   0}, { 25,   0}},
    {{ 21,   0}, { 16,   0}, { 14,   0}},
    {{  1,   9}, { -2,   9}, {-10,  51}},
...
//};
//
//const Bs8s CtxInitTable_24_39_x3[16][3][2] = {
    {{ 18,  64}, { 26,  34}, { 20,  40}},
    {{  9,  43}, { 19,  22}, { 20,  10}},
    {{ 29,   0}, { 40,   0}, { 29,   0}},
    {{ 26,  67}, { 57,   2}, { 54,   0}},
...
//};
//
//const Bs8s CtxInitTable_40_53_x3[14][3][2] = {
    {{ -3,  69}, { -2,  69}, {-11,  89}},
    {{ -6,  81}, { -5,  82}, {-15, 103}},
    {{-11,  96}, {-10,  96}, {-21, 116}},
    {{  6,  55}, {  2,  59}, { 19,  57}},
...
//};
//
//const Bs8s CtxInitTable_54_59_x3[6][3][2] = {
    {{ -7,  67}, { -1,  66}, {  3,  55}},
    {{ -5,  74}, { -1,  77}, { -4,  79}},
    {{ -4,  74}, {  1,  70}, { -2,  75}},
    {{ -5,  80}, { -2,  86}, {-12,  97}},
...
const Bs8s CtxInitTable_60_69_x1[10][2] = {
// 60 - 69
    {  0,  41},
    {  0,  63},
    {  0,  63},
...
const Bs8s CtxInitTable_70_275_x4[206][4][2] = {
//const Bs8s CtxInitTable_70_104_x4[35][4][2] = {
...
//};
//
//const Bs8s CtxInitTable_105_165_x4[61][4][2] = {
...
//};
//
//const Bs8s CtxInitTable_166_226_x4[61][4][2] = {
...
//};
//
//const Bs8s CtxInitTable_227_275_x4[49][4][2] = {
...
const Bs8s CtxInitTable_277_1023_x4[747][4][2] = {
//const Bs8s CtxInitTable_277_337_x4[61][4][2] = {
...
//};
//
//const Bs8s CtxInitTable_338_398_x4[61][4][2] = {
...
//};
//
//const Bs8s CtxInitTable_399_401_x4[3][4][2] = {
    {{ 31,  21}, {12, 40}, {25, 32}, {21, 33}},
    {{ 31,  31}, {11, 51}, {21, 49}, {19, 50}},
    {{ 25,  50}, {14, 59}, {21, 54}, {17, 61}},
//};
//
//const Bs8s CtxInitTable_402_459_x4[58][4][2] = {
...
//};
//
//const Bs8s CtxInitTable_460_483_x4[24][4][2] = {
    {{-17, 123}, { -7,  92}, {  0,  80}, { 11,  80}},
    {{-12, 115}, { -5,  89}, { -5,  89}, {  5,  76}},
    {{-16, 122}, { -7,  96}, { -7,  94}, {  2,  84}},
    {{-11, 115}, {-13, 108}, { -4,  92}, {  5,  78}},
...
//};
//
//const Bs8s CtxInitTable_484_571_x4[88][4][2] = {
    {{ -7,  93}, { -2,  85}, {-13, 103}, { -4,  86}},
    {{-11,  87}, { -6,  78}, {-13,  91}, {-12,  88}},
    {{ -3,  77}, { -1,  75}, { -9,  89}, { -5,  82}},
    {{ -5,  71}, { -7,  77}, {-14,  92}, { -3,  72}},
...
//};
//
//const Bs8s CtxInitTable_572_659_x4[88][4][2] = {
    {{ 24,   0}, { 11,  28}, {  4,  45}, {  4,  39}},
    {{ 15,   9}, {  2,  40}, { 10,  28}, {  0,  42}},
    {{  8,  25}, {  3,  44}, { 10,  31}, {  7,  34}},
    {{ 13,  18}, {  0,  49}, { 33, -11}, { 11,  29}},
...
//};
//
//const Bs8s CtxInitTable_660_717_x4[58][4][2] = {
    {{-17, 120}, { -4,  79}, { -5,  85}, { -3,  78}},
    {{-20, 112}, { -7,  71}, { -6,  81}, { -8,  74}},
    {{-18, 114}, { -5,  69}, {-10,  77}, { -9,  72}},
    {{-11,  85}, { -9,  70}, { -7,  81}, {-10,  72}},
...
//};
//
//const Bs8s CtxInitTable_718_775_x4[58][4][2] = {
    {{-17, 120}, { -4,  79}, { -5,  85}, { -3,  78}},
    {{-20, 112}, { -7,  71}, { -6,  81}, { -8,  74}},
    {{-18, 114}, { -5,  69}, {-10,  77}, { -9,  72}},
    {{-11,  85}, { -9,  70}, { -7,  81}, {-10,  72}},
...
//};
//
//const Bs8s CtxInitTable_776_863_x4[88][4][2] = {
    {{ -6,  93}, {-13, 106}, {-21, 126}, {-22, 127}},
    {{ -6,  84}, {-16, 106}, {-23, 124}, {-25, 127}},
    {{ -8,  79}, {-10,  87}, {-20, 110}, {-25, 120}},
    {{  0,  66}, {-21, 114}, {-26, 126}, {-27, 127}},
...
//};
//
//const Bs8s CtxInitTable_864_951_x4[88][4][2] = {
    {{ 15,   6}, { 14,  11}, { 19,  -6}, { 17, -13}},
    {{  6,  19}, { 11,  14}, { 18,  -6}, { 16,  -9}},
    {{  7,  16}, {  9,  11}, { 14,   0}, { 17, -12}},
    {{ 12,  14}, { 18,  11}, { 26, -12}, { 27, -21}},
...
//};
//
//const Bs8s CtxInitTable_952_1011_x4[60][4][2] = {
    {{ -3,  71}, { -6,  76}, {-23, 112}, {-24, 115}},
    {{ -6,  42}, { -2,  44}, {-15,  71}, {-22,  82}},
    {{ -5,  50}, {  0,  45}, { -7,  61}, { -9,  62}},
    {{ -3,  54}, {  0,  52}, {  0,  53}, {  0,  53}},
...
//};
//
//const Bs8s CtxInitTable_1012_1023_x4[12][4][2] = {
    {{ -3,  70}, { -3,  74}, { -2,  73}, { -5,  79}},
    {{ -8,  93}, { -9,  92}, {-12, 104}, {-11, 104}},
    {{-10,  90}, { -8,  87}, { -9,  91}, {-11,  91}},
    {{-30, 127}, {-23, 126}, {-31, 127}, {-30, 127}},
...
void H264_CABAC::init_ctx(){
    slice_header& slice   = *ctx.slice;
    bool  isIntra  = ((slice.slice_type%5) == 2 || (slice.slice_type%5) == 4); 
    Bs16u SliceQPy = 26 + slice.pps_active->pic_init_qp_minus26 + slice.slice_qp_delta;
    Bs16u InitIdc  = !isIntra + slice.cabac_init_idc;
    Bs16u i = 0;

    if(InitIdc > 4 || slice.cabac_init_idc > 2){
    ...
    for(; i <= 59; i++)
        InitCtx(m_CtxState[i], CtxInitTable_11_59_x3[i-11][slice.cabac_init_idc], SliceQPy);

    for(; i <= 69; i++)
        InitCtx(m_CtxState[i], CtxInitTable_60_69_x1[i-60], SliceQPy);
    
    for(; i <= 275; i++)
        InitCtx(m_CtxState[i], CtxInitTable_70_275_x4[i-70][InitIdc], SliceQPy);

    m_CtxState[i++] = (63<<1);

    for(; i <= 1023; i++)
        InitCtx(m_CtxState[i], CtxInitTable_277_1023_x4[i-277][InitIdc], SliceQPy);

}

const Bs16s H264_CABAC::ctxIdxOffset[num_SE][2] = {
/*MB_TYPE_SI                                */ {        0,      3},
/*MB_TYPE_I                                 */ {        3,  ERROR},
/*MB_SKIP_FLAG_P_SP                         */ {       11,  ERROR},
/*MB_TYPE_P_SP                              */ {       14,     17},
/*SUB_MB_TYPE_P_SP                          */ {       21,  ERROR},
/*MB_SKIP_FLAG_B                            */ {       24,  ERROR},
/*MB_TYPE_B                                 */ {       27,     32},
/*SUB_MB_TYPE_B                             */ {       36,  ERROR},
/*MVD_LX_0                                  */ {       40, BYPASS},
/*MVD_LX_1                                  */ {       47, BYPASS},
/*REF_IDX_LX                                */ {       54,  ERROR},
/*MB_QP_DELTA                               */ {       60,  ERROR},
/*INTRA_CHROMA_PRED_MODE                    */ {       64,  ERROR},
/*PREV_INTRA4X4_PRED_MODE_FLAG              */ {       68,  ERROR},
/*REM_INTRA4X4_PRED_MODE                    */ {       69,  ERROR},
/*MB_FIELD_DECODING_FLAG                    */ {       70,  ERROR},
/*CODED_BLOCK_PATTERN_LUMA                  */ {       73,     77},
/*CODED_BLOCK_FLAG_LT5                      */ {       85,  ERROR},
/*SIGNIFICANT_COEFF_FLAG_FRAME_LT5          */ {      105,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FRAME_LT5     */ {      166,  ERROR},
/*COEFF_ABS_LEVEL_MINUS1_LT5                */ {      227, BYPASS},
/*COEFF_SIGN_FLAG                           */ {   BYPASS,  ERROR},
/*END_OF_SLICE_FLAG                         */ {TERMINATE,  ERROR},
/*SIGNIFICANT_COEFF_FLAG_FIELD_LT5          */ {      277,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FIELD_LT5     */ {      338,  ERROR},
/*TRANSFORM_SIZE_8X8_FLAG                   */ {      399,  ERROR},
/*SIGNIFICANT_COEFF_FLAG_FRAME_EQ5          */ {      402,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FRAME_EQ5     */ {      417,  ERROR},
/*COEFF_ABS_LEVEL_MINUS1_EQ5                */ {      426, BYPASS},
/*SIGNIFICANT_COEFF_FLAG_FIELD_EQ5          */ {      436,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FIELD_EQ5     */ {      451,  ERROR},
/*CODED_BLOCK_FLAG_GT5_LT9                  */ {      460,  ERROR},
/*CODED_BLOCK_FLAG_GT9_LT13                 */ {      472,  ERROR},
/*CODED_BLOCK_FLAG_EQ_5_9_13                */ {     1012,  ERROR},
/*SIGNIFICANT_COEFF_FLAG_FRAME_GT5_LT9      */ {      484,  ERROR},
/*SIGNIFICANT_COEFF_FLAG_FRAME_GT9_LT13     */ {      528,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FRAME_GT5_LT9 */ {      572,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FRAME_GT9_LT13*/ {      616,  ERROR},
/*COEFF_ABS_LEVEL_MINUS1_GT5_LT9            */ {      952, BYPASS},
/*COEFF_ABS_LEVEL_MINUS1_GT9_LT13           */ {      982, BYPASS},
/*SIGNIFICANT_COEFF_FLAG_FIELD_GT5_LT9      */ {      776,  ERROR},
/*SIGNIFICANT_COEFF_FLAG_FIELD_GT9_LT13     */ {      820,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FIELD_GT5_LT9 */ {      864,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FIELD_GT9_LT13*/ {      908,  ERROR},
/*SIGNIFICANT_COEFF_FLAG_FRAME_EQ9          */ {      660,  ERROR},
/*SIGNIFICANT_COEFF_FLAG_FRAME_EQ13         */ {      718,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FRAME_EQ9     */ {      690,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FRAME_EQ13    */ {      748,  ERROR},
/*COEFF_ABS_LEVEL_MINUS1_EQ9                */ {      708, BYPASS},
/*COEFF_ABS_LEVEL_MINUS1_EQ13               */ {      766, BYPASS},
/*SIGNIFICANT_COEFF_FLAG_FIELD_EQ9          */ {      675,  ERROR},
/*SIGNIFICANT_COEFF_FLAG_FIELD_EQ13         */ {      733,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FIELD_EQ9     */ {      699,  ERROR},
/*LAST_SIGNIFICANT_COEFF_FLAG_FIELD_EQ13    */ {      757,  ERROR},
};

const Bs8s H264_CABAC::ctxIdxIncTbl[num_SE_main][2][7] = {
/*MB_TYPE_SI                  */{{ EXTERNAL,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR}, { EXTERNAL,TERMINATE,        3,        4, EXTERNAL, EXTERNAL,        7},},
/*MB_TYPE_I                   */{{ EXTERNAL,TERMINATE,        3,        4, EXTERNAL, EXTERNAL,        7}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*MB_SKIP_FLAG_P_SP           */{{ EXTERNAL,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*MB_TYPE_P_SP                */{{        0,        1, EXTERNAL,    ERROR,    ERROR,    ERROR,    ERROR}, {        0,TERMINATE,        1,        2, EXTERNAL,        3,        3},},
/*SUB_MB_TYPE_P_SP            */{{        0,        1,        2,    ERROR,    ERROR,    ERROR,    ERROR}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*MB_SKIP_FLAG_B              */{{ EXTERNAL,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*MB_TYPE_B                   */{{ EXTERNAL,        3, EXTERNAL,        5,        5,        5,        5}, {        0,TERMINATE,        1,        2, EXTERNAL,        3,        3},},
/*SUB_MB_TYPE_B               */{{        0,        1, EXTERNAL,        3,        3,        3,    ERROR}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*MVD_LX_0                    */{{ EXTERNAL,        3,        4,        5,        6,        6,        6}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*MVD_LX_1                    */{{ EXTERNAL,        3,        4,        5,        6,        6,        6}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*REF_IDX_LX                  */{{ EXTERNAL,        4,        5,        5,        5,        5,        5}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*MB_QP_DELTA                 */{{ EXTERNAL,        2,        3,        3,        3,        3,        3}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*INTRA_CHROMA_PRED_MODE      */{{ EXTERNAL,        3,        3,    ERROR,    ERROR,    ERROR,    ERROR}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*PREV_INTRA4X4_PRED_MODE_FLAG*/{{        0,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*REM_INTRA4X4_PRED_MODE      */{{        0,        0,        0,    ERROR,    ERROR,    ERROR,    ERROR}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*MB_FIELD_DECODING_FLAG      */{{ EXTERNAL,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR}, {    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
/*CODED_BLOCK_PATTERN_LUMA    */{{ EXTERNAL, EXTERNAL, EXTERNAL, EXTERNAL,    ERROR,    ERROR,    ERROR}, { EXTERNAL, EXTERNAL,    ERROR,    ERROR,    ERROR,    ERROR,    ERROR},},
};

const Bs8u ctxIdxBlockCatOffset[4][14] = {
...
const Bs8u ctxIdxIncScf8x8[64][3] = {
