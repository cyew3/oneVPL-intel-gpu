...
set MSDK_PLUGIN_HW_DISPATCH_REGISTRY=HKEY_LOCAL_MACHINE\SOFTWARE\Intel\MediaSDK\Dispatch\iHSW_0D26\Plugin
set MSDK_PLUGIN_HW_DISPATCH_REGISTRY_WOW3264=HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Intel\MediaSDK\Dispatch\iHSW_0D26\Plugin
:: HEVC ENCODE PLUGIN
...
echo "ky"
reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v Type /t REG_DWORD /d 00000001 /f
reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v CodecID /t REG_DWORD /d %MSDK_HEVC_CODEC_ID% /f
reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v GUID /t REG_BINARY /d %HEVC_HW_PLUGIN_DECODE_GUID% /f
reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v Name /t REG_SZ /d "Intel (R) Media SDK HW plugin for HEVC DECODE" /f
if "%PROCESSOR_ARCHITECTURE%"=="x86" (
:: for x86 systems :: 
...
if "%PROCESSOR_ARCHITECTURE%"=="x86" (
:: for x86 systems :: 
    reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v Path /t REG_SZ /d "%PATH_TO_BRANCH%build\\win_Win32\\bin\\%HEVC_HW_PLUGIN_DECODE_GUID%\\%HEVC_HW_X86_PLUGIN_DECODE_NAME%" /f
) else (
:: for x64 systems
    reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v Path /t REG_SZ /d "%PATH_TO_BRANCH%build\\win_x64\\bin\\%HEVC_HW_PLUGIN_DECODE_GUID%\\%HEVC_HW_X64_PLUGIN_DECODE_NAME%" /f
)
reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v PluginVersion /t REG_DWORD /d %PLUGIN_VERSION% /f
reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v APIVersion /t REG_DWORD /d %MSDK_API_VER% /f
reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v Default /t REG_DWORD /d 0 /f

:: Wow6432Node for HEVC DECODE PLUGIN
if NOT "%PROCESSOR_ARCHITECTURE%"=="x86" (
    reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY_WOW3264%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v Type /t REG_DWORD /d 00000001 /f
    reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY_WOW3264%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v CodecID /t REG_DWORD /d %MSDK_HEVC_CODEC_ID% /f
    reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY_WOW3264%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v GUID /t REG_BINARY /d %HEVC_HW_PLUGIN_DECODE_GUID% /f
    reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY_WOW3264%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v Name /t REG_SZ /d "Intel (R) Media SDK HW plugin for HEVC DECODE" /f
    reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY_WOW3264%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v Path /t REG_SZ /d "%PATH_TO_BRANCH%build\\win_Win32\\bin\\%HEVC_HW_PLUGIN_DECODE_GUID%\\%HEVC_HW_X86_PLUGIN_DECODE_NAME%" /f
    reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY_WOW3264%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v PluginVersion /t REG_DWORD /d %PLUGIN_VERSION% /f
    reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY_WOW3264%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v APIVersion /t REG_DWORD /d %MSDK_API_VER% /f
    reg add "%MSDK_PLUGIN_HW_DISPATCH_REGISTRY_WOW3264%\%HEVC_HW_PLUGIN_DECODE_GUID%" /v Default /t REG_DWORD /d 0 /f
)
