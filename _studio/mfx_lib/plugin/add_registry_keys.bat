...
reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY%\%HEVC_SW_PLUGIN_ENCODE_GUID%" /v PlgVer /t REG_DWORD /d 00000001 /f
reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY%\%HEVC_SW_PLUGIN_ENCODE_GUID%" /v APIVer /t REG_DWORD /d %MSDK_API_VER% /f
...
if NOT "%PROCESSOR_ARCHITECTURE%"=="x86" (
    ...
    reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY_WOW3264%\%HEVC_SW_PLUGIN_ENCODE_GUID%" /v PlgVer /t REG_DWORD /d 00000001 /f
    reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY_WOW3264%\%HEVC_SW_PLUGIN_ENCODE_GUID%" /v APIVer /t REG_DWORD /d %MSDK_API_VER% /f
...
reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY%\%HEVC_SW_PLUGIN_DECODE_GUID%" /v PlgVer /t REG_DWORD /d 00000001 /f
reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY%\%HEVC_SW_PLUGIN_DECODE_GUID%" /v APIVer /t REG_DWORD /d %MSDK_API_VER% /f
...
if NOT "%PROCESSOR_ARCHITECTURE%"=="x86" (
    ...
    reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY_WOW3264%\%HEVC_SW_PLUGIN_DECODE_GUID%" /v PlgVer /t REG_DWORD /d 00000001 /f
    reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY_WOW3264%\%HEVC_SW_PLUGIN_DECODE_GUID%" /v APIVer /t REG_DWORD /d %MSDK_API_VER% /f
...
reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY%\%VPP_SW_PLUGIN_GUID%" /v PlgVer /t REG_DWORD /d 00000001 /f
reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY%\%VPP_SW_PLUGIN_GUID%" /v APIVer /t REG_DWORD /d %MSDK_API_VER% /f
...
if NOT "%PROCESSOR_ARCHITECTURE%"=="x86" (
    ...
    reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY_WOW3264%\%VPP_SW_PLUGIN_GUID%" /v PlgVer /t REG_DWORD /d 00000001 /f
    reg add "%MSDK_PLUGIN_DISPATCH_REGISTRY_WOW3264%\%VPP_SW_PLUGIN_GUID%" /v APIVer /t REG_DWORD /d %MSDK_API_VER% /f
