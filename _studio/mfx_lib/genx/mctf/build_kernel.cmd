...
rem if "%2"=="kbl" set JIT_TARGET=gen9_5 & set PLATFORM_NAME=kbl
rem if "%2"=="cnl" set JIT_TARGET=gen10 & set PLATFORM_NAME=cnl
...
set TMP=%CURDIR%\..\build\win_x64\genx\mctf
...
rem SET ICLDIR=%CM5INSTDIR%\compiler
rem SET ICLDIR=%CM6INSTDIR%\compiler
...
set CM_COMPILER_OPTIONS=/c /Qunroll1 /Qxcm /Qxcm_jit_target=%JIT_TARGET% .\src\genx_%KERNEL%.cpp /Qxcm_nonstrict /mGLOB_override_limits /mCM_print_asm_count /mCM_printregusage /Dtarget_%JIT_TARGET% %OPTIONS%
