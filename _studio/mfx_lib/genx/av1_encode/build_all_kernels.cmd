...
echo interpolate_decision_single >> list_of_kernels.tmp
...
for /F %%i in (list_of_kernels.tmp) do (
  ...
  rem call build_codec_kernel.cmd av1 %%i bdw /Qxcm_release
  call build_codec_kernel.cmd av1 %%i skl /Qxcm_release
  rem call build_codec_kernel.cmd av1 %%i cnl /Qxcm_release
  rem call build_codec_kernel.cmd av1 %%i icl /Qxcm_release
  rem call build_codec_kernel_cmc.cmd av1 %%i icllp /Qxcm_release
)
